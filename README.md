...
7. (Optional) Start more guitarists to see them appear in real time:
   ...
   QUARKUS_STORK_BAND_SERVICE_SERVICE_REGISTRAR_INSTANCE_NAME=Flying GUITAR_HERO_PORT=9003 GUITAR_HERO_DELAY_MS=200 mvn quarkus:dev -pl guitar-hero-service
   ```
